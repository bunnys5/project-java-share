...
public class ChackGoods extends JDialog implements ActionListener {
	...
	public ChackGoods(JFrame frame) {
		super(frame, true);
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (actionCommand.equals(acceptString)) {
			...
			try {
				...
				Chack chackgoods = new Chack(name, ReceiveDate);
	...
	private void acceptchack(Chack chackgoods) {
